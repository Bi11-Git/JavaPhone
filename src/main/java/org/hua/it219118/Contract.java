...
public abstract class Contract {
    ...
    public void configuringContract() {
        ...
        System.out.print("In how match days from now do you want to start the contract? (0 start now) : ");
        ...
        System.out.print("Give the duration of this contract (1 - 24 months) :");
